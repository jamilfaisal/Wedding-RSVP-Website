import { brideFirstName, groomFirstName, email } from '@/lib/config/wedding-config';
    ...
    <div className="lg:col-span-1">
      <div className="bg-white/95 backdrop-blur-sm rounded-lg p-8 shadow-xl border border-sage-100 relative">
        ...
        <div className="text-center mb-8">
          ...
          <h2
            className="text-3xl text-brown-800 mb-6"
        ...
        <div className="space-y-6">
          <div className="text-center">
            <h3
              className="text-xl text-brown-800 mb-4"
              style={{ fontFamily: 'var(--font-harrington)' }}
            >
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-center space-x-3">
                ...
                <a
                  href="mailto:faris.zina@wedding.com"
          ...
          <div className="border-t border-sage-100 pt-6">
            <div className="text-center">
              ...
              <div className="flex items-center justify-center space-x-2 text-brown-600">
                ...
                <span style={{ fontFamily: 'var(--font-serif)' }}>Rome, Italy</span>
              </div>
              <p
