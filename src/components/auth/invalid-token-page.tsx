          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-lg shadow-xl border border-sage-200 p-8 text-center">
            ...
            <div className="space-y-3">
              <Button
                ...
                className="w-full bg-sage-600 hover:bg-sage-700 text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200"
              >
                {t('auth.loginInstead')}
              </Button>
              ...
              <Button
                ...
                className="w-full bg-white border border-sage-300 hover:bg-sage-50 text-sage-700 font-medium py-3 px-4 rounded-lg transition-colors duration-200"
              >
                {t('common.backToHome')}
              </Button>
            </div>
